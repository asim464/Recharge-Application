    ...
    <div class="main-header-right row m-0">
      <div class="main-header-left">
        <div class="logo-wrapper">
          <a href="/dashboard"
            ><img class="img-fluid" src="../assets/images/logo/recharge.png" alt=""
          /></a>
        </div>
        <div class="dark-logo-wrapper">
          <a href="/dashboard"
            ><img
              class="img-fluid"
              src="../assets/images/logo/dark_logo.png"
              alt=""
          /></a>
        </div>
       ...
       <!-- <img class="image-fluid img " src="../assets/images/logo/header.png"  alt="" style="text-align:center">  -->
      ...
      <div class="nav-right col pull-right right-menu p-0 nav-bar">
        <ul class="nav-menus">
          <!-- <li>
            <a
              class="text-dark"
            ...
            <!-- <div class="bookmark-dropdown onhover-show-div"> -->
              ...
              <!-- <ul class="m-t-5">
                <li class="add-to-bookmark">
                  <i class="bookmark-icon" data-feather="inbox"></i>Email<span
                    class="pull-right"
                ...
                <li class="add-to-bookmark">
                  <i class="bookmark-icon" data-feather="command"></i>Feather
          ...
          <li class="onhover-dropdown p-0">
            <button class="btn btn-primary-light" type="button">
              <a v-on:click="logout()"><i data-feather="log-out"></i>Log out</a>
            </button>
          </li>
        </ul>
      </div>
