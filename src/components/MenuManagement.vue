<template>
  <div class="page-body">
    ...
    <div class="container-fluid" @click="focusOut">
      <div class="row">
        <div class="col-md-12">
          <div class="card">
              ...
              <ul class="nav nav-tabs border-tab" id="top-tab" role="tablist">
                ...
                <li class="nav-item">
                  <a
                    ...
                    ><label id="lbl-add-company">Add Menu</label></a
                  >
                </li>
              </ul>
                ...
                >
                  <div class="table-responsive">
                    <table class="display" id="example-style-1">
                      ...
                      <tbody>
                        <tr v-for="item in menudata" :key="item.menu_id">
                          <td>{{ item.menu_id }}</td>
                          ...
                          <td>
                            <a
                              ...
                              v-on:click="updatecompany(item.menu_id)"
                              ><span class="fa fa-edit"></span
                            ></a>
                            &nbsp;
                            <a
                              class="btn btn-danger btn-sm"
                              v-on:click="deletecompany(item.menu_id)"
                  ...
                  >
                    <form  @submit.prevent="menuname">
                      ...
                      <!-- <div class="row pb-2 parent-menu-div" hidden>
                        <div class="col-md-2">
    ...
    <div class="container-fluid" id="icons-div" hidden>
      <div class="row">
        <div class="col-sm-12">
          <div class="card">
            <div class="card-header pb-0">
...
export default {
  ...
  async created() {
    ...
    this.menudata = response.data.menu_data;
  },
  methods: {
    async menuname() {
      const formdata = [
      ...
      if (formdata[0].menu_id) {
        console.log("updated");
        // alert("in updated")
        console.log("form data  ", formdata);
        const response = await axios.put(apiLink.api + "menu", formdata);
      ...
      const resp = await axios.post(apiLink.api + "menu", formdata);
      if (resp.status == 201) {
        console.log(resp);
        // window.location.reload();
    ...
    onFocus() {
      $("#icons-div").attr("hidden", false);
    },
    focusOut() {
      $("#icons-div").attr("hidden", true);
      this.menu_icon = $("#input_copy").val();
    },
    showparentdd() {
      if ($("#is-parent").is(":checked")) {
        $(".parent-menu-div").attr("hidden", true);
      } else {
        $(".parent-menu-div").attr("hidden", false);
      }
    },
    async deletecompany(id) {
      ...
      const response = await axios.patch(apiLink.api + "menu", formdata);
      if (response.data.response == "Success!") {
        console.log(response.data.response);
        // window.location.reload();
    ...
    updatecompany(id) {
      var valObj = this.menudata.filter(function (elem) {
        if (elem.menu_id == id) return elem;
      });
      ...
      $("#lbl-add-company").text("Update Menu");
      $("#update_company").text("Update");
      $("#company_listing").removeClass("active show");
      this.menu_name = valObj[0].menu_name;
      this.menu_url = valObj[0].menu_url;
      this.menu_icon=valObj[0].menu_icon;
      this.is_parent=valObj[0].is_parent;
      this.menu_id=valObj[0].menu_id;
      this.parent_menu_id = valObj[0].parent_menu_id;
    },
  },
};
</script>
