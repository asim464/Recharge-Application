<template>
  <b-card-code>
    ...
    >
      ...
      >
        <span
          v-if="props.column.label ==='fleet_name'"
          class="text-nowrap"
        >
          {{ $t('message.tableHeader.fleet_name') }}
        </span>
        <span
          v-else-if="props.column.label ==='number_of_vehicles'"
          class="text-nowrap"
        >
          {{ $t('message.tableHeader.number_of_vehicles') }}
        </span>
        <span
          v-else-if="props.column.label ==='startDate'"
          class="text-nowrap"
        >
          {{ $t('message.tableHeader.startDate') }}
        </span>
        <span
      ...
      >
        ...
        <!-- Column: Name -->
        <span
          v-if="props.column.field === 'fleet_name'"
          class="text-nowrap"
        >
          <!-- <b-avatar
            ...
            class="mx-1"
          /> -->
          <span>{{ props.row.fleet_name }}</span>
        </span>
...
export default {
  ...
  created() {    
    let id = 1 
    fetch("http://10.0.107.221:5000/fleet_management/"+id,{
          method:"GET",          
      }).then(
        (response) => {
